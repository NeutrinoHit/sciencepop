...
::: {.slide-viz}
::: {.universe-viz data-universe-viz="redBlueShift"}
:::
:::
...
::: {.slide-viz}
::: {.universe-viz data-universe-viz="hubbleLaw"}
:::
:::
...
::: {.universe-viz .universe-viz-large data-universe-viz="sphereSurface"}
:::
...
<div class="cosmic-history-page">
  ...
  <div class="history-floating-media history-media-light">
    <div class="media-frame history-media-frame">
...
<video
  ...
  preload="metadata"
  controls>
  <source src="assets/figures/bbn-nucleosynthesis-manim.mp4?v=bb0fd7d" type="video/mp4">
</video>
```
...
$$
R_\mathrm{He} \simeq \frac{2(n/p)}{1-(n/p)}.
$$
При $n/p=1/7$ получаем
$$
R_\mathrm{He} \simeq 0.33.
$$
...
[neutrinohit.github.io/sciencepop/BirthAndLifeUniverse/bbn-game/bbn_applet.html](https://neutrinohit.github.io/sciencepop/BirthAndLifeUniverse/bbn-game/bbn_applet.html){.bbn-qr-link}
:::

::: {.bbn-qr-card}
![](assets/figures/bbn-game-qr.png){fig-alt="QR-код для игры Синтезируй сам лёгкие элементы"}
:::
...
::: {.elements-origin-slide}
::: {.elements-origin-head}
::: {.elements-origin-title}
Происхождение золота
:::

::: {.elements-origin-subtitle}
И других химических элементов
:::
:::

::: {.media-figure .elements-origin-figure style="--media-max-height: 515px; --media-caption-align: flex-start; --media-caption-size: 0.34em; --media-caption-weight: 650;"}
![](assets/figures/element-origin-periodic-table-ru.png){fig-alt="Периодическая таблица химических элементов с цветовой разметкой их происхождения"}
...
## Образование галактик {.full-slide-video-section}
...
## Темная материя видна гравитацией {.full-slide-video-section}
...
## Реликтовый свет {.media-center-section}

::: {.media-center-slide}
::: {.media-figure style="--media-max-height: 560px; --media-bg: #000;"}
![](assets/figures/cmb-map-trimmed.jpg){fig-alt="Карта реликтового излучения по данным Планк"}
...
::: {.media-center-slide}
  ...
  <video class="slide-video" style="--media-width: min(100%, 980px); --media-max-height: 590px; --media-bg: #03050a; --media-shadow: 0 18px 46px rgba(0, 0, 0, 0.34); --media-radius: 6px;" data-slide-video muted playsinline loop preload="metadata" poster="assets/figures/wmap-shape-of-universe-poster.png">
...
::: {.slide-viz}
::: {.universe-viz data-universe-viz="darkEnergy"}
:::
:::
...
::: {.quiz-slide .future-quiz-slide}
::: {.quiz-prompt}
Возможные сценарии
:::

::: {.quiz-options .future-quiz-options}

::: {.quiz-option}
**А.** Большое замерзание<br><small>Вселенная замерзнет</small>
:::

::: {.quiz-option}
**Б.** Большой разрыв<br><small>Вселенную разорвет</small>
:::

::: {.quiz-option}
**В.** Большое схлопывание<br><small>Вселенная начнет сжиматься в точку</small>
:::
