...
**Гелий-4** почти напрямую считает, сколько нейтронов дожило до открытия дейтериевого горлышка:
...
bbnLectureApp = {
  ...
  const app = window.BBNUI.createApp(bbnLectureGrid, {
    ...
    footerHtml: `
      ...
      <a href="https://github.com/NeutrinoHit/sciencepop/tree/main/BirthAndLifeUniverse/bbn-game">Source code</a>
    `
  });
  invalidation.then(() => {
